...
\todo[inline]{This is work in progress, ideally should be 1 page long}

The obvious approach would be to require a program in our programming language to be a pair \(F, p\),
where \(F\) would be e.g.\ a C++ function and \(p\) would be a polynomial bounding the number
of steps of \(F\) when executed on a normal computer. For at least \todo{careful with three}three
...
Few examples of concrete Turing machine definitions have been described.
There are examples provided in\cite{KUDLEK1996241} and~\cite{ROGOZHIN1996215}.

Formally defining Turing machines has been considered in~\cite{10.1007/978-3-642-32621-9_1} and,
building on top of it,~\cite{10.1145/3372885.3373816}\footnote{This
describes the origins of a formalization project available at:
...
Also in ciaffaglione there are some turing machines.
