...
by the computer, and the code of the checker is simple enough to be widely believable, is called a \emph{proof assistant}.
...
where they fail.
Similarly, Liquid Haskell extends Haskell with functionality allowing the user to
specify correctness properties using liquid types~\cite{10.1145/1375581.1375602}.
A recent work adapts the same liquid-type approach to Rust~\cite{10.1145/3591283}.
...
Formally defining Turing machines has mostly been considered in~\cite{10.1007/978-3-642-32621-9_1} and,
...
Interesting concrete examples were provided in\cite{KUDLEK1996241},~\cite{ROGOZHIN1996215} and in the work
we discuss in~\autoref{sec:ciaffaglione}.
Alternative approaches are studied as Synthetic~Computability~\cite{BAUER20065}.

In~\autoref{remark:heraud-nowak}, we briefly discuss one formalization of \emph{a characterization}
of polynomial-time functions.

\section{Ciaffaglione's formalization of undecidability of HALT}\label{sec:ciaffaglione}
