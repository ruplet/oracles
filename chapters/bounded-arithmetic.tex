...
\section{\(\texttt{VAC}^0\) as a theory for \(\complexity{FAC}^0\)}\label{sec:vac0}

\subsection{Pigeonhole principle}\label{subsec:vac0-php}
\todo[inline]{Here we cite the result that \(\texttt{VAC}^0 \nvdash \texttt{PHP}\)}

PHP is proved to be independent from V0 in~\cites[Corollary~7.21]{CookNguyenDraft}[Corollary~VII.2.4]{Cook_Nguyen_2010}.
