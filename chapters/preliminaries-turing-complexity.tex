\section{Decisional Turing machine complexity classes}\label{sec:decisional-complexity-classes}
...
that study general functions \(f : \{0,1\}^\ast \to \{0,1\}^\ast\), in complexity theory usually
used to define \emph{reductions}. The results
