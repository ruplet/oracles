...
the approach that we study in~\autoref{chap:bounded-arithmetic}. We will also circle back
to this intuition while considering the \(\texttt{PIGEON}\) problem in~\ref{def:pigeon} and
the unprovability of the pigeonhole principle in the weak theories studied in~\ref{subsec:vac0-php}.
