...
are of interest to us and provide basis for new programming languages.
...
considerations that we will explore in~\autoref{chap:recursion-theory}.

Lambda calculus does
not, however, line up cleanly with traditional Turing machine complexity measures.  For instance,
...
lambda calculus (STLC), with regular languages. But with a different encoding of inputs,
...
Nevertheless, typed lambda calculi are the basis of one of the successful approaches towards our problem of
characterizing complexity classes syntactically, and will be discussed further in~\autoref{chap:linear-types}.
