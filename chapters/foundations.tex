...
for circuits
would probably have to generate,
...
through the field of descriptive complexity which we explore in more detail in~\cite{chap:descriptive-complexity}.
...
Concepts from linear logic had been implemented in type theory,
