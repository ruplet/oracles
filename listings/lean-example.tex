...
\PY{k}{by}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} peano.Formula (Vars2 .y .x) is the type of deeply\PYZhy{}embedded formulas}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} with two free variables, \PYZdq{}y\PYZdq{} and \PYZdq{}x\PYZdq{}}
...
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} similarly below, \PYZdq{}y\PYZdq{} cannot be free in `ind2`.}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} `iBdEx\PYZsq{} t phi` denotes `∃ var ≤ t . phi` for some variable name `var`}
...
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} `display1` takes a formula with 1 free variable and makes it explicit}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} that it is intended to be bound by the induction axiom scheme}
...
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} prove that the formula actually is Delta0}
...
\PY{+w}{      }\PY{n}{constructor}\PY{n+nb+bp}{;}\PY{+w}{ }\PY{n}{constructor}
\PY{+w}{  }\PY{o}{)}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} use our custom macro to simplify `ind` to use it in proving}
\PY{+w}{  }\PY{n}{simp\PYZus{}induction}\PY{+w}{ }\PY{k}{at}\PY{+w}{ }\PY{n}{ind}
\PY{+w}{  }\PY{c+c1}{\PYZhy{}\PYZhy{} proceed with the proof by induction; name subgoals; clear helpers}
