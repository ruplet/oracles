...
\input{listings/lean-unicode.tex}
...
\begin{abstract}
The aim of this thesis is to certify complexity bounds by construction: to design programming and specification
formalisms whose syntax guarantees membership in a target complexity class, so that verifying a program's complexity
reduces to checking that it is syntactically correct. We systematically examine several lines of work that
appear to support this goal, including formal verification of semantics of standard programming languages,
descriptive complexity,
and programming languages from implicit computational complexity.
Our conclusions are mostly negative: in their current form, these approaches do not scale to certifying
the complexity of realistic algorithms.

The positive outcome of this investigation is a shift of focus to bounded arithmetic,
whose theories are known to capture a range of complexity classes.
We argue that, when combined with modern proof assistants, bounded arithmetic offers a viabl
basis for complexity-certified programming. Concretely, we implement in Lean~4 a
formalization of bounded arithmetical theories and prototype mechanisms for extracting code from
their proofs. This mechanization illustrates how proofs of totality of functions within such theories
can serve as a foundation for certifying both correctness and resource bounds of programs.
\end{abstract}
...
\include{chapters/formalized-semantics}
\include{chapters/descriptive-complexity}
\include{chapters/reductions}
\include{chapters/icc}
\include{chapters/bounded-arithmetic}

\appendix
\include{chapters/appendix-uniformity}
\include{chapters/appendix-neergaard-algebra}
