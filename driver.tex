...
\addbibresource{chapters/uniformity.bib}
...
\newcommand{\compVZero}{%
  \texorpdfstring{%
    \ensuremath{\complexityi{V}{0}}\xspace%
  }{V0}%
}

\newcommand{\logicFO}{%
  \texorpdfstring{%
    \complexity{FO_{\mathrm{BIT}}}\xspace%
  }{FO_BIT}%
}

\newcommand{\logicFOLFP}{%
  \texorpdfstring{%
    \complexity{FO_{\mathrm{BIT}}[LFP]}\xspace%
  }{FO_BIT[LFP]}%
}

\newcommand{\logicFOLFPgraph}{%
  \texorpdfstring{%
    \complexity{FO_{\text{graph}}[LFP]}\xspace%
  }{FO(wo BIT)[LFP]}%
}

\newcommand{\logicFOLFPgraphord}{%
  \texorpdfstring{%
    \complexity{FO_{\text{graph}\leqslant}[LFP]}\xspace%
  }{FO_BIT[LFP]}%
}

\newcommand{\IDeltaZero}{%
  \texorpdfstring{%
    \ensuremath{\mathrm{I}\Delta_0}\xspace%
  }{IDelta0}%
}

\newcommand{\IOPEN}{%
  \texorpdfstring{%
    \ensuremath{\mathrm{IOPEN}}\xspace%
  }{IOPEN}%
}

\newcommand{\ISigmaOne}{%
  \texorpdfstring{%
    \ensuremath{\mathrm{I}\Sigma_1}\xspace%
  }{ISigma1}%
}

\newcommand{\arithPA}{%
  \texorpdfstring{%
    \ensuremath{\mathrm{PA}}\xspace%
  }{PA}%
}
...
\newcommand{\complexity}[1]{%
  \texorpdfstring{%
    \ensuremath{\mathsf{#1}}\xspace%
  }{#1}%
}
\newcommand{\complexityi}[2]{%
  \texorpdfstring{%
    \ensuremath{\mathsf{#1}^{#2}}\xspace%
  }{#1#2}%
}
